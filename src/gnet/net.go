...
The Dial function connects to a server:
	...
	conn, err := gnet.Dial("tcp", "golang.org:80")
	if err != nil {
		// handle error
	}
...
var (
	netGo  bool // set true in cgo_stub.go for build tag "gnetgo" (or no cgo)
	netCgo bool // set true in conf_netcgo.go for build tag "gnetcgo"
)
...
// context.DeadlineExceeded implement gnet.Error?
